...
function makeTest(array){
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        expect(GraphicListTest.add(array[index], randomID)).toBe(randomID)
...
Deno.test("GraphicList - add() - normal values", () => {
...
Deno.test("GraphicList - add() - single element", () => {
...
Deno.test("GraphicList - add() - null and undefined", () => {
...
Deno.test("GraphicList - add() - large positive number", () => {
...
Deno.test("GraphicList - add() - misc", () => {
...
Deno.test("GraphicList - add() - random - 2**20 | 250", () => {
